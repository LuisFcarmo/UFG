...
int main() {
    printf("--------------------------------------------------------------------------------------------------------------------\n");
    const char* fileName = "./img/proerd.png";
    png_bytep *RowPointer;
    int width, height;
    
    char bin[strlen(proerd)*8];
    for (int i = 0; i < strlen(proerd); i++) {
        CharToBin(proerd[i], &bin[i*8]);
    }
    ...
    LoadPngImage(fileName, &RowPointer, &width, &height);
    PrintSequenceBin(RecoverMessage(RowPointer, width, height, bin), strlen(proerd));
    FreePngImage(RowPointer, height);
    printf("--------------------------------------------------------------------------------------------------------------------\n\n");
    //michael schot
    fileName = "./img/michael.png";
    bin[strlen(Michael)*8];
    for (int i = 0; i < strlen(Michael); i++) {
        CharToBin(Michael[i], &bin[i*8]);
    }
    ...
    Save(fileName, RowPointer, width, height);
    LoadPngImage(fileName, &RowPointer, &width, &height);
    PrintSequenceBin(RecoverMessage(RowPointer, width, height, bin), strlen(Michael));
    FreePngImage(RowPointer, height);

    printf("--------------------------------------------------------------------------------------------------------------------\n\n");

    //cachoro foda
    fileName = "./img/foda.png";

    bin[strlen(cachoro)*8];
    for (int i = 0; i < strlen(cachoro); i++) {
        CharToBin(cachoro[i], &bin[i*8]);
    }
    ...
    Save(fileName, RowPointer, width, height);
    LoadPngImage(fileName, &RowPointer, &width, &height);
    PrintSequenceBin(RecoverMessage(RowPointer, width, height, bin), strlen(cachoro));
    FreePngImage(RowPointer, height);
    printf("--------------------------------------------------------------------------------------------------------------------\n\n");
    ...
    bin[strlen(Acabou)*8];
    for (int i = 0; i < strlen(Acabou); i++) {
        CharToBin(Acabou[i], &bin[i*8]);
    }
    ...
    Save(fileName, RowPointer, width, height);
    LoadPngImage(fileName, &RowPointer, &width, &height);
    PrintSequenceBin(RecoverMessage(RowPointer, width, height, bin), strlen(Acabou));
    FreePngImage(RowPointer, height);
